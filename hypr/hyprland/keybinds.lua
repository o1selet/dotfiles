...
hl.bind(mainMod .. " + F", hl.dsp.exec_cmd("flclashx"))
...
hl.bind(mainMod .. " + A", hl.dsp.workspace.toggle_special("terminal"))
hl.bind(mainMod .. " + D", hl.dsp.workspace.toggle_special("social"))
